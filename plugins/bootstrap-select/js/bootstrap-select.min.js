        ...
        c.VERSION = "1.13.2", c.BootstrapVersion = _.major, c.DEFAULTS = {
            ...
            createDropdown: function () {
                var e = this.multiple || this.options.showTick ? " show-tick" : "",
                    ...
                    i = this.options.header ? '<div class="' + q.POPOVERHEADER + '"><button type="button" style="transform: translate3d(0px, 0px, 0px)" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>" : "",
